...
figure()
plot(fechas(:,1),M_x30,'Color',[0.4940 0.1840 0.5560])
datetick('x','yyyy')
...
figure()
plot(fechas(:,1),M_x21,'Color',[0.3010 0.7450 0.9330])
datetick('x','yyyy')
...
subplot 312
plot(1:12,promedio_30,'Color',[0.4940 0.1840 0.5560])
...
subplot 313
plot(1:12,promedio_21,'Color',[0.3010 0.7450 0.9330])
title('Transporte de Ekman fuera de la costa 21°S')
xlabel('Años')
ylabel('promedio transporte en x [m^2/s]')
axis tight
...
hold on 
plot(1:12,promedio_30,'Color',[0.4940 0.1840 0.5560],'linewidth',3)
plot(1:12,promedio_21,'Color',[0.3010 0.7450 0.9330],'linewidth',3)
...
figure()
subplot 221
histogram(verano,-5:1:10,'Normalization', 'probability','FaceColor', [0.4940 0.1840 0.5560]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
xlabel('[m/día]')
ylabel('Porcentaje [%]')
...
subplot 222
histogram(otono,-5:1:10, 'Normalization', 'probability','facecolor',[0.4940 0.1840 0.5560]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
subplot 223
histogram(invierno,-5:1:10, 'Normalization', 'probability','facecolor',[0.4940 0.1840 0.5560]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
subplot 224
histogram(primavera,-5:1:10, 'Normalization', 'probability','facecolor',[0.4940 0.1840 0.5560]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
figure()
subplot 221
histogram(verano,-5:1:10,'Normalization', 'probability','FaceColor', [0.3010 0.7450 0.9330]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
xlabel('[m/día]')
ylabel('Porcentaje [%]')
...
subplot 222
histogram(otono,-5:1:10, 'Normalization', 'probability','facecolor',[0.3010 0.7450 0.9330]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
subplot 223
histogram(invierno,-5:1:10, 'Normalization', 'probability','facecolor',[0.3010 0.7450 0.9330]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
subplot 224
histogram(primavera,-5:1:10, 'Normalization', 'probability','facecolor',[0.3010 0.7450 0.9330]);
ytix = get(gca, 'YTick');
set(gca, 'YTick',ytix, 'YTickLabel',ytix*100);
ylabel('Porcentaje [%]')
xlabel('[m/día]')
...
figure()
plot(-x, v_E1,'Color',[0 0.4470 0.7410],'linewidth',3)
hold on
plot(-x,v_E2,'Color',[0.6350 0.0780 0.1840],'linewidth',3)
